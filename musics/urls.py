...
urlpatterns = [
    ...
    path("bands/<int:pk>/", views.BandDetailView.as_view(),
         name="banddetail"),

    path("labels/", views.LabelListView.as_view(), name="labellist"),
    path("labels/<int:pk>/", views.LabelDetailView.as_view(),
         name="labeldetail"),
    ...
    path("genre/<int:genre_id>/",
         views.GenreWiseSongView.as_view(), name="genredetail"),

    path("artistsong/<int:artist_id>/",
         views.AllSongsByArtist.as_view(), name="artistsong"),

    path("albumsong/<int:album_id>/",
         views.AllSongsInAlbum.as_view(), name="albumsong"),
]
