...
urlpatterns = [
    ...
    path('genre-movies/<int:genre_id>', views.GenerMoviesList.as_view(), name="genremovie"),
    path('studio/', views.MovieStudioList.as_view(), name="studiolist"),
    path('studio/<int:pk>/', views.MovieStudioDetail.as_view(), name="studiodetail"),
    path('directors/', views.MovieDirectorList.as_view(), name="directorlist"),
    path('directors/<int:pk>/', views.MovieDirectorDetail.as_view(), name="directordetail"),
